...
public class GridPasswordView extends AppCompatTextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPasswordLength = a.getInteger(R.styleable.gridPasswordView_gpvPasswordLength, DEFAULT_PASSWORD_LENGTH);
        mLineWidth = a.getDimensionPixelSize(R.styleable.gridPasswordView_gpvLineWidth, dp2px(1));
        mLineHeight = a.getDimensionPixelSize(R.styleable.gridPasswordView_gpvLineHeight, dp2px(40));
        mLineColor = a.getColor(R.styleable.gridPasswordView_gpvLineColor, Color.GRAY);
        ...
        mXLineHeightFull = a.getBoolean(R.styleable.gridPasswordView_gpCursorHeightgpXLineHeightFull, false);
        a.recycle();
    }
...
/*        //绘制竖线
    ...
    private boolean shouldBlink() {
        Log.d(TAG,"mCursorVisiable==="+mCursorVisiable + "isFocused()==="+isFocused()+ "mCursorBitmapDrawable==="+mCursorBitmapDrawable);
